...
vector < vector <float> > blur(vector < vector < float> > grid, float blurring) {
    ...
    if(blurring!=0){
        ...
        // Finding center location & SETTING CENTER PROBABILITY
        int cen_r, cen_c;
        ...
        // Setting adjacent location probabilities
        newGrid[r1][cen_c] = adjacent_prob;
        newGrid[r2][cen_c] = adjacent_prob;
        newGrid[cen_r][c1] = adjacent_prob;
        newGrid[cen_r][c2] = adjacent_prob;

        // Setting corner location probabilities
        newGrid[r1][c1] = corner_prob;
        newGrid[r2][c1] = corner_prob;
        newGrid[r1][c2] = corner_prob;
        newGrid[r2][c2] = corner_prob;
    }
    else{
        newGrid = grid;
    }
